...
class TableGUI:
    def __init__(self, master):
        ...
        self.search_canvas.configure(xscrollcommand=self.input_hscrollbar.set,
                                     yscrollcommand=self.search_vscrollbar.set)
    ...
    def execute_search(self):
        ...
        for column, entry in self.search_entries.items():
            ...
            if column in self.string_columns:
                ...
                if len(word) != 0:
                    search_df = self.filter_Integer(self.df, firstOperator=wordop, firstNumber=word, columnName=column)
    ...
    @staticmethod
    def filter_Integer(df, firstOperator=None, firstNumber=None, secondOperator=None, secondNumber=None,
                       columnName=None):
        """
        ...
        if (firstOperator != None and secondNumber != None):
            line_df = line_df[(ops[firstOperator](line_df[columnName], firstNumber)) & (
                ops[secondOperator](line_df[columnName], secondNumber))]
